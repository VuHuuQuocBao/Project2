    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
               new AppConfig() { Key = "HomeTitle", Value = "This is home page of Project" },
               new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of Project" },
               new AppConfig() { Key = "HomeDescription", Value = "This is description of Project" }
               );
